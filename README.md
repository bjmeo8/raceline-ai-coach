...
RaceLine AI Coach is an end-to-end telemetry and AI coaching platform that helps Toyota GR Cup drivers compare their laps to a “golden” reference, visualize pace gaps, and receive targeted recommendations generated by Gemini 2.5 Pro.
...
- Automatic CSV → Parquet conversion that shrinks the 17 GB raw dataset to ~773 MB without losing fidelity
...
> 🎞️ Lap comparison walkthrough — see the ghost cars, highlighted segments, and tooltip interactions in motion.  
> 📹 Prefer video? [Watch the MP4 recording.](docs/medias/lap-comparizon-map-video.mp4)
...
- **Backend** → Cloud Run (`gcloud run deploy raceline-api ...`)
