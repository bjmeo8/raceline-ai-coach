...
// Initialize App
async function init() {
    console.log('🚀 Initializing RaceLine AI Coach...');
...
function renderVehicleList() {
    ...
    pageVehicles.forEach(vehicle => {
        ...
        button.className = `rounded px-4 py-4 text-left transition bg-gray-700 hover:bg-blue-600 ${
...
function renderLapList() {
    ...
    pageLaps.forEach(lap => {
        ...
        const button = document.createElement('button');
        button.className = `w-full rounded px-4 py-4 text-left transition bg-gray-700 hover:bg-green-600 ${
