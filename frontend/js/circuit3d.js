...
class Circuit3DViewer {
    ...
    init() {
        ...
        this.scene.background = new THREE.Color(0x1a2332); // ← Couleur plus claire
        ...
        // Lights - PLUS INTENSES
        const ambientLight = new THREE.AmbientLight(0xffffff, 1.0); // ← Plus fort
        this.scene.add(ambientLight);
        
        const directionalLight = new THREE.DirectionalLight(0xffffff, 1.5); // ← Plus fort
    ...
    createCircuit(userTelemetry, goldenTelemetry) {
        ...
        // Normalize GPS coordinates - ÉCHELLE RÉDUITE POUR AVOIR UN CIRCUIT RAISONNABLE
        const centerLon = userTelemetry[0].VBOX_Long_Minutes;
        const centerLat = userTelemetry[0].VBOX_Lat_Min;
        const scale = 500000; // ← RÉDUIT pour avoir circuit ~300 unités au lieu de 65000
        ...
        try {
            // Circuit track (tube) - MATÉRIAU ÉMISSIF
            ...
            const tubeMaterial = new THREE.MeshStandardMaterial({ 
                color: 0x475569,
                emissive: 0x1e293b, // ← Émission de lumière
            ...
            // User path line (red) - PLUS VISIBLE
            ...
            userLine.position.y = 1; // ← Au-dessus du circuit
            ...
            for (let i = 0; i < userPoints.length; i += sampleRate) {
                ...
                const sphereGeometry = new THREE.SphereGeometry(5, 16, 16); // ← Plus grosses
                ...
                sphere.position.y = 10; // ← Plus haut
